...
<div class="col-sm-12 content-header" style="">Xem chi tiế</div>
<div class="col-sm-12 content-body" >  
	...
	<div class="col-sm-6">
		<ul> 
            <li><i class="fp-ht-tv"></i>Giới tính ưu tiên: <?php echo $job->PREFEREDSEX; ?></li>
...
<p><i class="fa fa-paperclip"></i>Tệp đính kèm</p>
	<div class="col-sm-12 slider">
		 <h3>Tải xuống hồ sơ <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Nơi đây</a></h3>
	</div>  
	<div class="col-sm-12">
		<p>Nhận xét</p>
