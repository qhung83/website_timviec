  ...
  ?>  
          ...
          <div class="panel panel-primary">
              ...
              <!--           <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <p>Trình độ chuyên môn / Kinh nghiệm làm việc: :</p>
                    ...
                    <div class="col-sm-2"> <a href="<?php echo web_root; ?>index.php?q=apply&job=<?php echo $result->JOBID;?>&view=personalinfo" class="btn btn-main btn-next-tab">Áp dụng ngay bây giờ!</a></div>
                </div> 
