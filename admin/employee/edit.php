                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8"> 
                           <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder=
                              "nhập Họ" type="text" value="<?php echo $emp->FNAME;?>"   autocomplete="off">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8"> 
                          <input  class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
                              "nhập Tên"   value="<?php echo $emp->LNAME;?>"    autocomplete="off">
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8"> 
                          <input  class="form-control input-sm" id="MNAME" name="MNAME" placeholder=
                              "nhập Tên đệm"   value="<?php echo $emp->MNAME;?>"     autocomplete="off">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder=
                            "nhập Địa chỉ" type="text" value="" required   autocomplete="off"><?php echo $emp->ADDRESS;?></textarea>
                      </div>
                    </div>
                  </div> 
                      ...
                      <div class="col-md-8">
                        <div class="input-group">
                            <span class="input-group-addon"> 
                             ...
                             <input class="form-control input-sm date_picker" id="BIRTHDATE" name="BIRTHDATE" placeholder="nhập ngày sinh" type="text"    value="<?php echo date_format(date_create($emp->BIRTHDATE),'m/d/Y');?>" required  autocomplete="off">
                        </div>
                      </div>
                    </div>
                  </div> 
                                ...
                                <div class="col-md-8">
                                  ...
                                  <div class="col-md-8">
                                     ...
                                     <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder=
                                        "nhập Nơi sinh" type="text" value="" required   
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "nhập SĐT" type="text" any value="<?php echo $emp->TELNO;?>" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder=
                                      "Nhập vị trí" type="text" any value="<?php echo $emp->POSITION;?>" required   autocomplete="off">
                                </div>
                              </div>
                            </div>
