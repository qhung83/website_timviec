...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul> 
            <li><i class="fp-ht-tv"></i>Giới tính: <?php echo $job->PREFEREDSEX; ?></li>
...
<div class="col-sm-6 content-body" >
	...
	<ul> 
		...
		<li>SĐT: <?php echo $appl->CONTACTNO;?></li>
...
<p><i class="fa fa-paperclip"></i>Tệp đính kèm</p>
	<div class="col-sm-12 slider">
		 <h3>Tải xuống<a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Here</a></h3>
	</div> 
