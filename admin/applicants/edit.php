                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8"> 
                           <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder=
                              "nhập họ" type="text" value="<?php echo $emp->FNAME;?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8"> 
                          <input  class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
                              "nhập tên"   value="<?php echo $emp->LNAME;?>"   onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8"> 
                          <input  class="form-control input-sm" id="MNAME" name="MNAME" placeholder=
                              "Nhập tên đệm"   value="<?php echo $emp->MNAME;?>"    onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder=
                            "nhập địa chỉ" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $emp->ADDRESS;?></textarea>
                      </div>
                    </div>
                  </div> 
                    ...
                    <div class="form-group">
                                <div class="col-md-8">
                                  ...
                                  <div class="col-md-8">
                                     ...
                                     <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder=
                                        "nhập nơi sinh" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder=
                                      "Nhập chức vụ" type="text" any value="<?php echo $emp->POSITION;?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS" name="EMP_EMAILADDRESS" placeholder="nhập Email"   autocomplete="false" value="<?php echo  $emp->EMP_EMAILADDRESS; ?>"/> 
                                </div>
                              </div>
                            </div>  
