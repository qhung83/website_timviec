        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">quản lý việc làm<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">Công việc theo chức năng</a></li>
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Thuê mướn</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          37 Cầu giấy, Hà nội<br>
          <p>
            <i class="icon-phone"></i>(+001) 123-456-789 <br>
            <i class="icon-envelope-alt"></i> timvieclam@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Đường dẫn nhanh</h5>
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">Trang chủ</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company">Công ty</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">Thuê mướn</a></li>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Bài viết mới</h5>
          <ul class="link-list">
            <?php 
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; CampCodes 2021 Mọi quyền được bảo lưu.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
